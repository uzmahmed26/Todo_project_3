...
View Task List: Display all tasks with ID, status, title, and description
Update Task: Modify the title or description of an existing task
Delete Task: Remove a task from the list
Mark as Complete/Incomplete: Toggle the status of a task between "Complete" and "Incomplete"
Requirements
